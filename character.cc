...
character::load_textures()
{
	...
	textures[ 4] = texture::get_png("sprites/scribe-down-5.png");
	textures[ 5] = texture::get_png("sprites/scribe-down-6.png");
	textures[ 6] = texture::get_png("sprites/scribe-down-7.png");
	textures[ 7] = texture::get_png("sprites/scribe-up-1.png");
	textures[ 8] = texture::get_png("sprites/scribe-up-2.png");
	textures[ 9] = texture::get_png("sprites/scribe-up-3.png");
	textures[10] = texture::get_png("sprites/scribe-up-4.png");
	textures[11] = texture::get_png("sprites/scribe-up-5.png");
	textures[12] = texture::get_png("sprites/scribe-up-6.png");
	textures[13] = texture::get_png("sprites/scribe-up-7.png");
	textures[14] = texture::get_png("sprites/scribe-left-1.png");
	textures[15] = texture::get_png("sprites/scribe-left-2.png");
	textures[16] = texture::get_png("sprites/scribe-left-3.png");
	textures[17] = texture::get_png("sprites/scribe-left-4.png");
	textures[18] = texture::get_png("sprites/scribe-left-5.png");
	textures[19] = texture::get_png("sprites/scribe-left-6.png");
	textures[20] = texture::get_png("sprites/scribe-left-7.png");
	textures[21] = texture::get_png("sprites/scribe-right-1.png");
	textures[22] = texture::get_png("sprites/scribe-right-2.png");
	textures[23] = texture::get_png("sprites/scribe-right-3.png");
	textures[24] = texture::get_png("sprites/scribe-right-4.png");
	textures[25] = texture::get_png("sprites/scribe-right-5.png");
	textures[26] = texture::get_png("sprites/scribe-right-6.png");
	textures[27] = texture::get_png("sprites/scribe-right-7.png");
...
character::draw()
{
	...
	/* Draw front */
	textures[_dir * 7 + _state_frame]->bind();
